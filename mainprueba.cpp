...
/////////////////////////////////////////////////////////////////////////
	...
	for(;;)
	{
		...
		cout<<"x: "<<combi.posx()<<endl;
		cout<<"y: "<<combi.posy()<<endl;*/
		/*cout<<"=posicion actual del combi"<<endl;
		cout<<"x: "<<combi.posx()<<endl;
		cout<<"y: "<<combi.posx()<<endl;*/
		/*if(colision_superficie(combi,tico)==true)
		...
		//SDL_FreeSurface(pantalla);
		/*cout<<"pos combi"<<endl;//"--"<<"pos tico"<<endl;
		cout<<"x: "<<combi.posx()<<endl;//"    "<<"x: "<<tico.posx()<<endl;
		cout<<"y: "<<combi.posy()<<endl;//"    "<<"y: "<<tico.posy()<<endl;
		cout<<"pos carro"<<endl;//"--"<<"pos tico"<<endl;
		cout<<"x0: "<<grupo.getposx(0)<<"x1: "<<grupo.getposx(1)<<"x2: "<<grupo.getposx(2)<<endl;
		cout<<"y0: "<<grupo.getposy(0)<<"y1: "<<grupo.getposy(1)<<"y2: "<<grupo.getposy(2)<<endl;*/
		
		/*if (grupo.getposy(0)>600 || grupo.getposy(1)>600 || grupo.getposy(2)>600)
		{*/
		//if(nums[0]==0){
